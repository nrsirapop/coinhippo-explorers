  ...
  return (
    <div className="App">
      ...
      {!location.pathname || location.pathname === '/' ?
        <img src={logo} alt="logo" className="App-logo" style={{ maxWidth: '7.5rem', maxHeight: '7.5rem', margin: '1rem 0' }} />
        :
        <Header pathname={location.pathname} logo={<img src={logo} alt="logo" className="App-logo py-1" style={{ maxWidth: '4rem', maxHeight: '4rem' }} />} />
      }
